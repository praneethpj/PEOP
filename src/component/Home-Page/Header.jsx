                                ...
                                <form action="#" className="search">
                                    <div className="input-group w-100">
                                        <div className="input-group col-md-12">
                                            <input className="form-control py-2 border-right-0 border" type="search"  placeholder="I want a Mechaniery" id="example-search-input" />
                                        ...
                                        <div className="text">
...

                                            {
                                                ((localStorage.getItem("token") != null) && (selectUser != null)) ?
                                                    ...
                                                    </div> : <div className="widgets-wrap float-md-right"><Button className="btn btn-success " onClick={() => { handleLogin() }}>Sign Up / Sign In</Button>  </div>
